...
man2FullCopy.friends.push('Alex')
...
let peopleFullCopy= [...people.map(l=> ({...l}))]

peopleFullCopy[0].name="Alex" // your code
...
let man3FullCopy = {...man3, friends:[...man3.friends.map(l=> ({...l}))] }//  your code
...
let man5FullCopy = {...man5, mother:{...man5.mother ,work:{...man5.mother.work}, parents: [...man5.mother.parents.map(k=> ({...k}))] }}
...
let man6FullCopy = {...man6, mother: {...man6.mother, work: {...man6.mother.work},
        parents:[...man6.mother.parents.map(l=> ({...l, favoriteDish: {...l.favoriteDish}})),
        ]}}

man6FullCopy.name='Alex'
...
let man7FullCopy={...man7, mother: {...man7.mother , work:{ ...man7.mother.work},
        parents:[...man7.mother.parents.map(k=> ({...k, favoriteDish: {...k.favoriteDish ,
                ingredients: [...k.favoriteDish.ingredients.map(l=> ({...l}))]}}))] } }   //  your code
